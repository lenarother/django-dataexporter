...
from django_exporter.exporter import Exporter, action_export_factory
from tests.mockapp.models import MockModel, RelatedMockModel
...
class TestExporter:
    ...
    @mock.patch('django_exporter.exporter.Exporter.export_as_xlsx')
    @mock.patch('django_exporter.exporter.Exporter.export_as_csv')
